...
export function setExtraModelRequestOverrides(overrides: ExtraModelRequestOverrides | null | undefined) {
  current_request_overrides = overrides && Object.keys(overrides).length > 0 ? { ...overrides } : null;
}
...
export function applyExtraModelRequestOverrides(generate_data: Record<string, any>) {
  ...
  if (overrides.max_tokens !== undefined) {
    ...
    generate_data.max_completion_tokens = overrides.max_completion_tokens ?? overrides.max_tokens;
  }
