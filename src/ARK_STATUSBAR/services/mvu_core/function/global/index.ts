...
import { loadInitVarData } from '../initvar/variable_init';
...
function createMvu() {
  const mvu = {
     ...
     */
    parseMessage: async function (message: string, old_data: MvuData): Promise<MvuData | undefined> {
    ...
    /** @deprecated */
    getRecordFromMvuData: function (mvu_data: MvuData, category: 'stat' | 'display' | 'delta'): Record<string, any> {
