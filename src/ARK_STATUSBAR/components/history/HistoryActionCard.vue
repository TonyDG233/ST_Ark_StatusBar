<template>
  <div class="border p-3 flex flex-col relative bg-surface-container-low transition-colors box-border"
    ...
    <div class="flex flex-col relative group">
      <div class="text-[calc(10em/14)] font-display font-bold tracking-wider uppercase mb-1 whitespace-normal"
      ...
      <div class="text-[calc(11em/14)] mt-1 leading-tight break-words whitespace-normal min-w-0 pr-6"
