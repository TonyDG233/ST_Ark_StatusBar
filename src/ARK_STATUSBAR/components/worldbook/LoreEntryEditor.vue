<template>
  <div class="bg-surface-container-highest border-b border-outline-variant p-2 flex flex-col gap-3 box-border w-full min-w-0">
    ...
    <div class="flex flex-col gap-2 min-w-0 w-full">
      ...
      <div class="flex flex-wrap gap-2 min-w-0 w-full">
        <div class="flex flex-col gap-0.5 flex-1 min-w-[80px] max-w-full">
          ...
          <select class="bg-surface border-b border-outline-variant hover:border-outline px-1 py-1 text-[calc(10em/14)] text-on-surface focus:outline-none focus:border-primary transition-colors font-mono w-full min-w-0 box-border outline-none cursor-pointer">
            <option>条件</option>
            <option>常驻</option>
          </select>
        </div>
    ...
    <div class="flex flex-wrap justify-end items-center gap-2 mt-1 flex-shrink-0 w-full">
      ...
      <button class="px-3 py-1 bg-primary-container text-on-primary border border-primary-container font-display font-bold text-[calc(10em/14)] hover:bg-primary transition-colors flex items-center gap-1 outline-none cursor-pointer">
