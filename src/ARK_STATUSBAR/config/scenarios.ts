...
export const STARTUP_SCENARIOS: Scenario[] = [
  {
    swipeId: 1,
    title: '“作为博士被正常唤醒”',
    linkedWorldInfo: ['阿米娅（本格，与幼年、医疗、炉芯终曲选一开）', '罗德岛'],
    disabledWorldInfo: ['Mon3tr', 'Mon3tr锚定', '博士', 'user锚定'],
  },
  {
    swipeId: 2,
    title: '“依旧博士，但唤醒你的是W？”',
    linkedWorldInfo: ['W（本格，与维什戴尔选一开）', '萨卡兹', '巴别塔'],
    disabledWorldInfo: ['Mon3tr', 'Mon3tr锚定', '博士', 'user锚定'],
  },
  {
    swipeId: 3,
  ...
  },
  {
    ...
    linkedWorldInfo: ['大帝', '伊斯', '企鹅物流'],
  },
  { swipeId: 6, title: '“燎原”', linkedWorldInfo: ['塔露拉（斗士，与黑蛇选一开）', '阿丽娜', '乌萨斯'] },
  {
    swipeId: 7,
    title: '“穿越了，但穿的是迷迭香”',
    linkedWorldInfo: ['迷迭香', '凯尔希（本格，与Ama-10、巴别塔、预见末日的贤人选一开）', '罗德岛'],
  },
  { swipeId: 8, title: '“终末地”', linkedWorldInfo: ['佩丽卡', '管理员', '终末地（非游玩时请关闭）'] },
  {
    swipeId: 9,
    title: '“海嗣灭世”',
    linkedWorldInfo: ['浊心斯卡蒂（异格，与本格选一开）', '海嗣', '海嗣灭世（非游玩时请关闭）'],
    disabledWorldInfo: ['斯卡蒂（本格，与异格选一开）'],
  },
  {
    swipeId: 10,
    title: '“你与她的终末”',
    linkedWorldInfo: ['海嗣', '你与她的终末（非游玩时请关闭）', '浊心斯卡蒂（异格，与本格选一开）'],
    disabledWorldInfo: ['斯卡蒂（本格，与异格选一开）'],
  },
  ...
  { swipeId: 13, title: '“加油啊，制作人”', linkedWorldInfo: ['塞壬唱片MSR', '尤里卡', '阮薇薇', '遥'] },
  {
    ...
    linkedWorldInfo: ['卡兹戴尔', '萨卡兹', '预见末日的贤人'],
    disabledWorldInfo: [
  ...
  },
  {
    ...
    linkedWorldInfo: ['普瑞赛斯', 'Ama-10（与凯尔希、巴别塔、预见末日的贤人选一开）'],
    disabledWorldInfo: ['Mon3tr', 'Mon3tr锚定', '博士', 'user锚定'],
  },
  ...
  { swipeId: 20, title: '“卡西米尔一般路过游客（并非）”', linkedWorldInfo: ['卡西米尔'] },
  {
    swipeId: 21,
    title: '“我的幼驯染天使”',
    linkedWorldInfo: ['拉特兰', '蕾缪乐（幼年，与本格、异格选一开）'],
    disabledWorldInfo: [
      '能天使（本格，与幼年、异格选一开）',
      '蕾缪安（本格，与少女选一开）',
      '莫斯提马（本格，与少女选一开）',
  ...
  { swipeId: 22, title: '“莱茵生命纪实”', linkedWorldInfo: ['克丽斯腾', '塞雷娅', '莱茵生命'] },
  {
    swipeId: 23,
    title: '“岁岁今朝”',
    linkedWorldInfo: ['炎', '朔（早年，与本格重岳选一开）', '颉（整合了现有信息的先行版，非游玩时请关闭）'],
    disabledWorldInfo: [
      '年（本格，与早年选一开）',
      '夕（本格，与早年选一开）',
      '令（本格，与早年选一开）',
  ...
  },
  {
    swipeId: 24,
    title: '“泰拉万事屋”',
    linkedWorldInfo: ['荒芜拉普兰德（无序的谦卑，与幼狼、本格、异格选一开）'],
    disabledWorldInfo: ['拉普兰德（本格，与幼狼、异格、无序的谦卑选一开）'],
  },
  { swipeId: 25, title: '“摸鱼侦探事务所”', linkedWorldInfo: ['鲤氏侦探事务所', '老鲤', '槐琥', '吽', '阿'] },
  {
    swipeId: 26,
    title: '“博士救出作战第一号”',
    linkedWorldInfo: ['阿米娅（本格，与幼年、医疗、炉芯终曲选一开）', 'Ace', 'Scout'],
  },
  {
    swipeId: 27,
    title: '“当佣兵何尝不算是一种搜打撤”',
    linkedWorldInfo: ['卡兹戴尔', 'W（本格，与维什戴尔选一开）', '伊内丝', '赫德雷'],
  },
  ...
  },
  {
    swipeId: 34,
    title: '“修道院往事”',
    linkedWorldInfo: ['拉特兰', '聆音', '埃莉丝', '空弦', '塑心（本格，与幼年选一开）'],
  },
  {
    swipeId: 35,
    title: '“双狼记”',
    ...
    disabledWorldInfo: ['德克萨斯（本格，与幼狼、异格选一开）', '拉普兰德（本格，与幼狼、异格、无序的谦卑选一开）'],
  },
  ...
  { swipeId: 37, title: '“You！”', linkedWorldInfo: ['维多利亚', '澄闪'] },
  {
    ...
    disabledWorldInfo: ['博士', 'user锚定'],
  },
  {
    swipeId: 39,
    title: '“往日种种，你当真不记得了？”',
    linkedWorldInfo: ['普瑞赛斯', '博士', '凯尔希（本格，与Ama-10、巴别塔、预见末日的贤人选一开）', 'Mon3tr'],
    disabledWorldInfo: ['Mon3tr', 'Mon3tr锚定', '博士', 'user锚定'],
  },
  {
    swipeId: 40,
  ...
  },
  {
    swipeId: 41,
    title: '“深海猎人，血脉相连”',
    linkedWorldInfo: ['阿戈尔', '斯卡蒂（本格，与异格选一开）', '幽灵鲨（本格，与异格选一开）', '歌蕾蒂娅', '乌尔比安'],
    disabledWorldInfo: ['归溟幽灵鲨（异格，与本格选一开）'],
  },
  {
    swipeId: 42,
    title: '“匡 扶 深 池”',
    linkedWorldInfo: ['维多利亚', '深池', '蔓德拉', '苇草（本格，与幼龙、异格选一开）', '死芒（本格，与幼龙选一开）'],
    disabledWorldInfo: ['拉芙希妮·都柏林（幼龙，与本格、异格选一开）', '爱布拉娜·都柏林（幼龙，与本格选一开）'],
  },
