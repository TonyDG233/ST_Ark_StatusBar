    ...
    <div class="flex flex-col gap-4 flex-1 min-h-0 overflow-y-auto ark-scrollbar p-2">
      ...
      <div class="flex flex-col gap-2 flex-shrink-0">
        ...
        >
          <div class="flex flex-col gap-2">
            <select
              class="bg-surface text-[11px] text-on-surface border border-outline-variant px-2 py-1 outline-none w-full"
            >
          ...
          <div class="flex flex-col gap-2">
            ...
            <div class="flex flex-col gap-1 mt-2 border-t border-outline-variant/50 pt-2">
              <div class="flex flex-col border border-outline-variant bg-surface-container-lowest p-2 min-w-0">
                ...
                <div class="text-[10px] text-on-surface-variant mb-2 truncate max-w-full">
                  📁 实体文件: [ARK_BACKUP_Rhodes_Island_Core]_v1.2版本
                </div>
                <div class="flex flex-wrap gap-2 justify-end">
      ...
      <div class="flex flex-col flex-shrink-0 mt-4">
        ...
        <div class="flex flex-col gap-2 pb-2 border-b border-outline-variant mb-4">
          <div
            class="font-display text-[11px] font-bold tracking-widest uppercase text-on-surface-variant flex justify-between items-center px-1 flex-wrap gap-2"
          >
            <div class="flex items-center gap-2 flex-wrap">
              <span>COMMIT_LOG / 操作历史</span>
              <div
                class="text-[9px] px-1.5 py-0.5 rounded-sm bg-error/10 text-error border border-error/20 flex items-center gap-1 font-mono normal-case tracking-normal shrink-0"
              >
          ...
          >
            <div class="flex items-center gap-2 flex-1 min-w-0">
              ...
              <select
                class="bg-surface text-[11px] text-on-surface border border-outline-variant px-1 py-0.5 flex-1 min-w-0 outline-none w-full"
              >
        ...
        <div class="relative flex flex-col ml-1 pl-4 pb-4 border-l border-outline-variant border-dashed">
          ...
          <HistoryCommitItemDesign
            ...
            :isPinned="false"
            :isBatchMode="isBatchMode"
            :changes="[{ label: '切换', path: 'enabled', from: '关闭', to: '开启' }]"
          />
        </div>
