  ...
  <div class="relative w-full h-full bg-background slim-scroll-container overflow-y-auto flex flex-col box-border">
    ...
    <div class="p-2 flex flex-col gap-2 min-h-max box-border">
      ...
      <div class="w-full mt-4 flex flex-wrap gap-2">
        <button class="bg-surface border border-error text-error font-display text-[11px] font-bold tracking-widest uppercase py-2.5 hover:bg-error hover:text-on-error transition-colors flex items-center justify-center gap-1 flex-1 min-w-[120px] outline-none">
          <span class="material-symbols-outlined text-base">block</span>
          中止 (ABORT)
        </button>
        <button class="bg-primary text-on-primary font-display text-[11px] font-bold tracking-widest uppercase py-2.5 hover:bg-primary-container transition-colors flex items-center justify-center gap-1 flex-1 min-w-[120px] outline-none shadow-[0_0_8px_rgba(78,213,255,0.4)]">
